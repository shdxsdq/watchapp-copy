...
const STATE_KEY$1 = "watchreader.state.v1";
...
function loadReaderState$1() {
  const defaultState = createDefaultState$1();
  try {
    const savedValue = storage$1.getSync({
      key: STATE_KEY$1
    });
    ...
    return {
      ...
      progress: savedState.contentVersion === CONTENT_VERSION$1 ? savedState.progress || {} : {},
      contentVersion: CONTENT_VERSION$1,
      scrollProgress: savedState.contentVersion === CONTENT_VERSION$1 ? savedState.scrollProgress || {} : {},
...
function saveReaderState$1(state) {
  storage$1.set({
    key: STATE_KEY$1,
